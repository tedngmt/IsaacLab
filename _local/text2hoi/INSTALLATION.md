...
```bash
bash /home/nmt/Projects/IsaacLab/_local/text2hoi/run_mug.sh
```

To generate another sample:

```bash
bash /home/nmt/Projects/IsaacLab/_local/text2hoi/run_mug.sh --seed 43
```
...
at `\\wsl.localhost\Ubuntu\home\nmt\Projects\IsaacLab\_local\text2hoi\outputs`.
