...
Prepared 2026-09-17 using the user's clone at `C:\Linux\Text2HOI`, revision
...
```bash
bash /mnt/c/Linux/IsaacLab/_local/text2hoi/run_mug.sh
```

To generate another sample:

```bash
bash /mnt/c/Linux/IsaacLab/_local/text2hoi/run_mug.sh --seed 43
```
...
|---|---|
| `checkpoints/grab/` | `C:\Linux\Text2HOI_Download\Checkpoints\grab` |
| `data/grab/` data files | `C:\Linux\Text2HOI_Download\Preprocessing\grab` |
| `data/mano/mano_v1_2/models/` | Licensed files in `C:\Linux\SOMA-X\assets\MANO` |
